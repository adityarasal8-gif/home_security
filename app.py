...
with col1:
    ...
    st.info("🗣 *AI Narration:* Between 10PM–11:30PM, an unusual Wi-Fi signal and motion were detected near the entrance.")
    ...
    for _ in range(3):
        ...
        with placeholder.container():
            for idx, a in enumerate(alerts):
                ...
                unique_key = f"{a['Title']}{a['Location']}{idx}_{random.randint(0,9999)}"
                with col_btn1:
